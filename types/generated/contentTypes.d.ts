...
export interface ApiEstimatifEstimatif extends Schema.CollectionType {
  ...
  attributes: {
    ...
    workLines: Attribute.Component<'liste.work-line', true> &
      Attribute.Required &
      Attribute.SetMinMax<{
        min: 1;
      }>;
    user: Attribute.Relation<
      'api::estimatif.estimatif',
      'manyToOne',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::estimatif.estimatif': ApiEstimatifEstimatif;
